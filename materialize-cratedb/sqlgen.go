	...
	mapper := sql.NewDDLMapper(
		sql.FlatTypeMappings{
			sql.INTEGER: sql.MapSignedInt64(
				sql.MapStatic("BIGINT", sql.AlsoCompatibleWith("integer"), sql.AlsoCompatibleWith("numeric")),
				sql.MapStatic("NUMERIC(24)", sql.AlsoCompatibleWith("double precision")),
			),
			...
			sql.STRING_INTEGER: sql.MapStatic("NUMERIC(30)",
				sql.AlsoCompatibleWith("numeric"),
				sql.AlsoCompatibleWith("integer"),
			),
			sql.STRING_NUMBER: sql.MapStatic("DOUBLE PRECISION",
				sql.AlsoCompatibleWith("numeric"),
				sql.AlsoCompatibleWith("integer"),
			),
